...
KEYWORDS = [
    # ============================================================
    # ★ 1순위: 정부정책/투자일정 (국내 시장 직접 영향)
    # ============================================================
    "기재부", "기획재정부", "산업부", "산업통상자원부", "금융위", "금융위원회",
    "금감원", "금융감독원", "공정위", "공정거래위원회",
    "경제정책", "경제정책방향", "비상경제", "경제회의",
    "예산안", "세법개정", "세제", "법인세", "종부세", "양도세",
    "규제완화", "규제개혁", "규제혁신",
    "정부지원", "정부투자", "보조금", "R&D", "연구개발",
    "지원책", "대책", "종합대책", "육성", "펀드",
    "SOC", "사회간접자본", "인프라투자",
    "공매도", "공매도금지", "공매도재개",
    ...
    # ★ 2순위: 유명인사 거취/발언 (국내)
    # ============================================================
    "이재용", "최태원", "정의선", "구광모", "신동빈", "조원태",
    "한은총재", "한국은행총재", "금융위원장", "금감원장",
    "기재부장관", "산업부장관", "국무총리", "대통령",
    "회장", "부회장", "사장", "CEO", "총수",
    "구속", "영장", "재판", "사면", "복권",
    "기자간담회", "기자회견", "브리핑", "간담회",
